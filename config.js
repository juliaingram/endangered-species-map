...
"<div class='textblock'><p data-paragraph='main'>Less than one month after the judge issued his ruling, the American Petroleum Institute, the American Farm Bureau Federation and a handful of Republican-led states filed an <a href='https://www.bloomberglaw.com/public/desktop/document/CenterForBiologicalDiversityetalvBernhardtetalDocketNo419cv05206N/3?1659764782' target='_blank'><u style='text-decoration-color:#9EB777'>appeal</u></a>, requesting a stay order on the court’s determination as the appeal plays out. If granted, a stay would mean the 2019 rules would remain in place while the court reaches a verdict on the appeal. And if the appeal is successful, it would send environmental groups back to the starting line and keep loosened protections in place for future endangered and threatened species. </p></div>" + 
