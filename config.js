...
;
  ...
  "<div class='textblock'> <p data-paragraph='main'>&#8220This bee was present one year, it was absent the next year, and it never came back. And we looked so hard,&#8220 said Leif Richardson, an ecologist at the Xerces Society, the conservation group that petitioned for the bumble bee's listing as a federally endangered species.   </p>" + 
...
//   "<h3>PrairieD</h3>" +
 "<p> While the airport has argued it is preserving the &#8220highest&#8220 quality habitat within the prairie in its biological assessment submitted to the Fish and Wildlife Service, Telfer points out the so-called <span style='background-color:rgb(237, 195, 145, 0.8)'>high-quality areas</span> will quickly diminish without any sort of buffer.</p>" 
  + 
 "<p> &#8220Calling it high quality, low quality…is an excuse to destroy more of the prairie,&#8220 Telfer said. Prior to the discovery of the rusty-patched bumble bee in the area in 2021, the airport had already destroyed over six acres of what it called &#8220<span style='background-color:rgb(229, 211, 136, 0.6)'>low</span>&#8220 and &#8220<span style='background-color:rgb(206, 154, 142, 0.6)'>moderate</span>&#8220 quality prairie, including the area’s namesake &#8220bowl,&#8220 or natural amphitheater.</p>
;
  let divChapter21 =
